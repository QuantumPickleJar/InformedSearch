...
from utils import update,euclidean,infinity,memoize
import sys, random
...
def astar_search(problem, h=None):
    ...
    h = memoize(h or problem.heuristic or problem.h, 'h')
...
class GraphProblem(Problem):
    ...
    #Override this to be something meaningful in your graph domain, if you extend this class"
    def h(self, node):
        #Right now, h function is straight-line distance from a node's state to goal, if available.
